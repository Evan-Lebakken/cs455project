...
<body>
<div id="nav"></div>
<h2>You sure? That's a lot of responsibility...</h2>
<p><a class="btn btn-lg btn-success" href="cellarOrderCards.php" role="button">Back to Orders</a></p>
<p>
    <?php
        ...
        foreach($result_set as $tuple) {
            ...
            echo "
                         ...
                         <card class='my-2 mx-2 border border-secondary rounded' method='post'>
                             <card-body>
                                <form action='claimHandler.php' method='post'>
                                <div class='px-2'>
                                   <p>Order Time: $time</p>
                                ...
                                <input type='submit' name='update' value='Claim Responsibility!' onclick='document.location.href=\"claimHandler.php\"'>
                                </form>
                             </card-body>
                         </card>
                         ";
